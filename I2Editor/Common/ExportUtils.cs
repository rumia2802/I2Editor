...
public static class ExportUtils
{
    ...
    public static Dictionary<string, string> Merge(Dictionary<string, string> template, Dictionary<string, string> values)
    {
        // for each key in template, if it's not in values, set to empty string
        // else, set to value
