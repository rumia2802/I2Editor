...
public sealed class ExportedFile
{
	...
	public ExportedFile(FileStructure file)
	{
		...
		Metadata = new FileMetadata
		{
			...
			OnMissingTranslation = file.OnMissingTranslation,
			TermAppname = file.TermAppname,
			IgnoreDeviceLanguage = file.IgnoreDeviceLanguage,
			AllowUnloadingLanguages = file.AllowUnloadingLanguages,
			...
			UpdateFrequency = file.GoogleSpreadsheet.UpdateFrequency,
			InEditorCheckFrequency = file.GoogleSpreadsheet.InEditorCheckFrequency,
			UpdateSynchronization = file.GoogleSpreadsheet.UpdateSynchronization,
			UpdateDelay = file.GoogleSpreadsheet.UpdateDelay,
			AssetsSize = file.AssetsSize,
		};
		...
		for (int i = 0; i < file.Terms.Length; i++)
		{
			...
			Terms[i] = new TermMetadata
			{
				...
				Flags = term.Flags,
				LanguagesTouchSize = term.LanguagesTouchSize
			};
		}
	}
	...
	public FileStructure Reconstruct()
	{
		...
		file.OnMissingTranslation = Metadata.OnMissingTranslation;
		file.TermAppname = Metadata.TermAppname;
		file.IgnoreDeviceLanguage = Metadata.IgnoreDeviceLanguage;
		file.AllowUnloadingLanguages = Metadata.AllowUnloadingLanguages;
		...
		file.GoogleSpreadsheet.UpdateFrequency = Metadata.UpdateFrequency;
		file.GoogleSpreadsheet.InEditorCheckFrequency = Metadata.InEditorCheckFrequency;
		file.GoogleSpreadsheet.UpdateSynchronization = Metadata.UpdateSynchronization;
		file.GoogleSpreadsheet.UpdateDelay = Metadata.UpdateDelay;
		file.AssetsSize = Metadata.AssetsSize;
...
public class FileMetadata
{
	...
	public uint AssetsSize { get; set; }
}
...
public class TermMetadata
{
	...
	public uint LanguagesTouchSize { get; set; }
}